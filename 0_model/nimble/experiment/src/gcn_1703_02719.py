...
class ResnetGCN(nn.Module):
    def __init__(self, in_channels, backbone, out_channels_gcn=(85, 128), kernel_sizes=(5, 7)):
        ...
        self.layer4 = nn.Sequential(
            ...
            *[BottleneckGCN(2048, 2048, kernel_sizes[1], out_channels_gcn[1])]*5)
...
class GCN(BaseModel):
    def __init__(self, num_classes, in_channels=3, pretrained=True, use_resnet_gcn=True, backbone='resnet50', use_deconv=False,
