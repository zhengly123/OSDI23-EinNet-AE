...
then
    ...
    export TRT_LIB=/home/osdi23ae/TensorRT-8.2.0.6/targets/x86_64-linux-gnu/lib
    ...
    export NNET_HOME="${DIR%/*}"
    echo NNET_HOME=$NNET_HOME
    export PYTHONPATH=$NNET_HOME/build:$NNET_HOME/python:$NNET_HOME/pyinfinitensor/src:$TVM_HOME/python:$PYTHONPATH
